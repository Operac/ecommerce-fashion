...
const womanProducts = useMemo(() => {
  ...
  const handleSeeMore = () => {
    setVisibleCount((prev) => Math.min(prev + 9, womanProducts.length));
  };
          ...
          <div className="my-8">
            <p className="text-gray-600 text-lg font-medium">
              {womanProducts.length === 0 ? (
                ...
                <>
                  Showing {Math.min(visibleCount, womanProducts.length)} of{" "}
                  {womanProducts.length} products
                </>
              )}
            </p>
          </div>
          ...
          {womanProducts.length === 0 ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                {womanProducts.slice(0, visibleCount).map((item) => (
                  <div
                    key={item.id}
              ...
              {womanProducts.length > 9 && (
                <div className="flex justify-center mt-12 gap-4">
                  ...
                  {visibleCount < womanProducts.length && (
                    <button
